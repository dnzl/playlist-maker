...
import { Text, Flex, Callout, Strong, DataList, Button } from "@radix-ui/themes";
import { PlaylistSelection, SelectionType } from "../types";

type SummaryProps = {
  selectedPlaylist: PlaylistSelection;
  goToStep: (step: number) => void;
  selectedTracks: SelectionType;
};

export const Summary = ({ selectedPlaylist, goToStep, selectedTracks }: SummaryProps) => (
  <Flex direction="column" gap="6">
    <Callout.Root color="yellow">
      ...
      <Callout.Text>
        You're about to{" "}
        <Strong>
          {selectedPlaylist.type === "new" ? "create a new playlist" : "edit an existing playlist"}
        </Strong>
      </Callout.Text>
    </Callout.Root>
